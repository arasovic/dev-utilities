<script>
  ...
  const pageDescription = 'Generate UUIDs (Universally Unique Identifiers) instantly. Create single or bulk UUID v4 for your applications. Free online UUID generator with copy functionality.'
